            ...
            <section class="text-gray-600 body-font relative">
                <div class="container px-5 md:34 lg:px-52 py-24 mx-auto">
                    <div class="flex flex-col text-center w-full mb-12">
                        <h1 class="sm:text-4xl text-2xl font-semibold title-font mb-4 text-gray-900">Need <span className='text-green-500'>help?</span></h1>
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">We're here to help! If you're experiencing any issues or have any questions about using VegFru, check out our Help Center for answers to frequently asked questions.</p>
                    </div>
