            ...
            <section class="text-gray-600 body-font">
                ...
                <div className='space-y-2 mb-8'>
                    <div class="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-4 sm:flex-row flex-col">
                        ...
                        <div class="flex-grow">
                            <h2 class="text-gray-800 text-md title-font font-semibold text-md mb-3">Permanent</h2>
                            <p class="leading-relaxed text-base text-xs">Sudha Rani Apartment, 1st Floor, Madurdaha, Hussainpur, Kolkata, West Bengal, India</p>
                            <div className=''>
                                <a class="mt-3 text-white bg-green-500 px-2 py-1 text-sm inline-flex items-center">Deliver here
                                </a>
                            </div>
                        </div>
                    </div>
