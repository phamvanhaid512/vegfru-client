...
import { getName, isLogin } from '../logics/logics';
...
const HomeNav = () => {
  ...
  return (
    <>
      <nav className='fixed z-50 top-0 w-full h-24 bg-white'>
        <div className='flex justify-between items-center h-full w-full px-4 md:px-14 lg:px-24'>
          <div className='flex items-center space-x-5'>
            ...
            <div className='hidden md:flex md:flex-col space-x-2 mt-4 text-xs md:text-[14px]'>
              <div className='md:flex-col'>
                ...
                <div class="border-b-2 border-gray-500 mt-2 w-8"></div>
              </div>

            </div>
          </div>
          <div className='hidden md:flex'>
            <ul className='hidden md:flex items-center md:space-x-6 lg:space-x-12'>
              <li>
                <Link to="/dashboard">
                  <div class="flex items-center space-x-4 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="text-gray-600 w-6 h-6 _1GTCc" >
              ...
              <li>
                <Link to="/about" onClick={() => console.log("Hello")}>
                  <div class="flex items-center space-x-4 cursor-pointer">
                    <svg
                      class="_1GTCc"
                      viewBox="0 0 32 32"
          ...
          <div className='md:hidden flex items-center space-x-4 cursor-pointer pr-2'>
              ...
              <DrawerContent>
                <DrawerBody>
                  <div className='flex flex-col'>
                    <ul className='flex justify-around items-center md:space-x-6 lg:space-x-12'>
                      <li>
                        <Link to="/dashboard">
                          <div class="flex flex-col justify-center items-center space-y-2 mt-4">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-gray-600 w-6 h-6 _1GTCc" >
                    ...
                    <p className='text-center text-[10px] mt-4 text-gray-600 px-20'> Copyright &copy; VegFru 2023 | Design & Developed by <a className='font-medium underline' href='https://linktr.ee/rajamrit'>Amrit Raj</a> </p>
                  </div>
                </DrawerBody>
              </DrawerContent>
            </Drawer>
